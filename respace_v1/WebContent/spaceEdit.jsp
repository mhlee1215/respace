		...
		$("#id_button_update")
		  .click(function( event ) {
			   ...
			   $.ajax({
				    type:"post",
				    data:str,
				    url:"spaceEditSubmit.do",
				    async: false,
				    success: function(msg){
				    	if( msg == 'success')
				       		alert('업데이트 성공!');
				    	 	document.location = 'spaceDetail.do?id=${space.id}';
				    }
				});
		   event.preventDefault();
		  });
...
<body onload="initialize()">
	...
	<div id="content_inner">
		<h3>
			<label>공간명: </label><input type="text" value="${space.name}" name="name"></input>
		</h3>
		</font>
			...
			<div class="left_portfolio" style="overflow: auto; height: 100%;">
				...
				<div id="tab_picture_container" class="tab_container">
					...
					<div id="tab_picture_content" class="tab_content">
						...
						<iframe width="660" height="450" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="imageSlider.do?id=${space.id}&type=space&readOnly=N"> 
                		</iframe>
						...
						<div id="tab_map_content" class="tab_content">
							<fieldset class="l2_fieldset">
								...
								<input type="text" id="address_simple" name="address_simple"
									value="${space.address_simple}" style="width: 80%"></input>
								...
								<input
									...
									style="width: 80%" value="${space.address_full }"></input>
			...
			<div class="right_portfolio">
				...
				<div class="price_container">
					...
					<div id="price0" class="how_much">
						...
						<b><input type="text" value="${space.price_hour}" name="price_hour"
					...
					<div id="price1" class="how_much">
						<h5>Standard Rental Rate</h5>
						<b><input type="text" value="${space.price_day}" style="width: 40%;" name="price_day"/>
							\</b><span>/Per Day</span> <br><br>
					</div>
					<!-- #price1 -->
					<div id="price2" class="how_much">
						<h5>Standard Rental Rate</h5>
						<b><input type="text" value="${space.price_week}" style="width: 40%;" name="price_week" />
					...
					<div id="price3" class="how_much">
						<h5>Standard Rental Rate</h5>
						<b><input type="text" value="${space.price_month}" style="width: 40%;" name="price_month"/>
					...
					<div>
						...
						<p>
							<b>임대료</b> <span><input type="text"
								style="width: 100px; display: inline" name="price_detail_rental" value="${space.price_detail_rental}">\</span>
							<br> <b>보증금</b> <span><input type="text"
									style="width: 100px; display: inline" name="price_detail_deposit" value="${space.price_detail_deposit}">\</span>
					...
					<div>
						...
						<p>
							<b>수용인원</b>&nbsp;&nbsp;최대 <input type="text"
								style="width: 20px; display: inline" value="${space.accommodation_min }" name="accommodation_min"></input>-<input
								type="text" style="width: 20px; display: inline" value="${space.accommodation_max }" name="accommodation_max"></input>명
							<br><b>이용시간</b>&nbsp;&nbsp;<input type="text"
								...
								style="width: 20px; display: inline" value="22:00" name="close_time"></input> <br><b>구비시설</b>&nbsp;&nbsp;<input
									...
									value="${space.facilities_list }" name="facilities_list"></input>
						</p>
			...
			<hr class="cleanit">
				...
				<hr class="cleanit">
					...
					<div style="float: right;">
						...
						<a href="space.do" class="button_light" id="id_button_update"
