...
<body>
    ...
    <div id="header">
        ...
        <h1><a href="index.html"><b>RE</b>SPACE</a></h1>
        
        <div id="menu">
         <ul>
            <li><a href="index.html" class="active">Home</a></li>
            <li><a href="about.html">SPACE</a></li>
            <li><a href="ourwork.html">PROJECT</a></li>
    ...
    <!-- *********  Main part (slider)  ********** -->
        ...
        <div id="service" >
            ...
            <div class="button_main">
                ...
                <ul><a href="about.html" class="button_dark">RESPACE</a></ul>
        ...
        <div id="content">
            ...
            <div class="fourths_portfolio">
                ...
                <a href="#"><img src="images/main_01_03.jpg" alt="item1"></a>
            </div>
            ...
            <p class="youlike">더 많은 정보를 보고 싶다면? <a href="ourwork.html">see more</a> or even <a href="contact.html">contact us</a> and get started on your project? Or are you thinking about <a href="cats.html">buying one of our cats</a>?</p>
    ...
    <hr class="cleanit">
     ...
     <div id="footer">
        <div id="footer_in">
            ...
            <span>리스페이스 <a href="http://blog.naver.com/respace">BLOG</a></span>
