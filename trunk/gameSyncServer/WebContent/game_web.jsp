...
<script type="text/javascript">
	...
	function resetGameScore() {
		...
		var i = 1;
		for (; i <= 3; i++) {
			$('#id_td_left_wins_circle_' + i).html(
					'<img width="20" src="images/circle_medium.png">');
			$('#id_td_right_wins_circle_' + i).html(
					'<img width="20" src="images/circle_medium.png">');
		}
	}
	...
	function showGameScore(data) {
		...
		for (; i <= data.leftUserWins; i++) {
			$('#id_td_left_wins_circle_' + i).html(
					'<img width="20" src="images/circle_big.png">');
		}
		for (; i <= 3; i++) {
			$('#id_td_left_wins_circle_' + i).html(
					'<img width="20" src="images/circle_medium.png">');
	...
	function showUserInfo(data, type) {
		if (type == 'left' || type == 'all') {
			if (data.leftUser != null) {
				$('#id_picture_left').attr(
						'src',
						'http://graph.facebook.com/' + data.leftUser.id
								+ '/picture?type=normal');
		...
		if (type == 'right' || type == 'all') {
			if (data.rightUser != null) {
				$('#id_picture_right').attr(
						'src',
						'http://graph.facebook.com/' + data.rightUser.id
								+ '/picture?type=normal');
	...
	function showDecisions(data, type) {
		if (type == 'left' || type == 'all') {
			if (data.leftUserChoise != null && data.leftUserChoise != '') {
				$('#id_left_choise').attr('src',
						'images/' + data.leftUserChoise + '_off.png');
			}
		}

		if (type == 'right' || type == 'all') {
			if (data.rightUserChoise != null && data.rightUserChoise != '') {
				$('#id_right_choise').attr('src',
						'images/' + data.rightUserChoise + '_off.png');
			}
		}

		if (type == 'reset') {
			$('#id_left_choise')
					.attr('src', 'images/' + 'unknown' + '_off.png');
			$('#id_right_choise').attr('src',
					'images/' + 'unknown' + '_off.png');
		}
	}
	...
	function showWinner(userData) {
		$('#id_winner_picture').attr(
				'src',
				'http://graph.facebook.com/' + userData.id
						+ '/picture?type=normal');
...
<body>
	...
	<table id="bodyTable" border="1" width="1024" height="695"
		...
		<tr height="12%">
			<td align="center"><img src="images/web_title.png" width="20%"
				alt=""></td>
		</tr>
		<tr height="10%">
			<td>
				<table width="100%">
					<tr>
						<td id="id_game_tic_td" align="center"></td>
					</tr>
				</table>
			</td>
		</tr>
					...
					<tr>
						...
						<td>
							<table width="100%">
								<tr>
									<td width="7%"></td>
									<td width="27%"><img id="id_left_choise" width="100%"
										src="images/unknown_off.png" alt="scissor" /></td>
									<td width="32%" align="center"><span id="id_game_score"
										style="font-size: 50px; color: #a9abae; font-family: 'Helvetica_Extended_Light';">2:3</span>
									</td>
									<td width="27%"><img id="id_right_choise" width="100%"
										src="images/unknown_off.png" alt="scissor" /></td>
									<td width="7%"></td>
								</tr>
							</table>
		...
		<tr id="id_game_result" height="37%" style="display: none">
			<td>
				<table border="0" width="100%">
					<tr>
						<td align="center"><img width="400" src="images/winner.png" />
						</td>
					</tr>
					<tr>
						<td align="center" valign="top"><img id="id_winner_picture"
							width="62" height="62" class="circle-mask"
							src="images/web_title.png"> <span id="id_winner_name"
							style="color: #a9abae; font-size: xx-large;">이름없음</span></td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr height="11%">
			<td>
				<table width="100%" border="0" style="border-spacing: 2px;">
					<tr>
						<td align="center">
							<table width="100%" height="30" style="border-spacing: 0px;">
								<tr>
									<td id="id_td_left_wins_circle_1" align="center"><img
										width="20" src="images/circle_big.png"></td>
									<td id="id_td_left_wins_circle_2" align="center"><img
										width="20" src="images/circle_medium.png"></td>
									<td id="id_td_left_wins_circle_3" align="center"><img
										width="20" src="images/circle_medium.png"></td>
								</tr>
							</table>
						</td>
						...
						<td align="center">
							<table width="100%">
								<tr>
									<td id="id_td_right_wins_circle_3" align="center"><img
										width="20" src="images/circle_big.png"></td>
									<td id="id_td_right_wins_circle_2" align="center"><img
										width="20" src="images/circle_big.png"></td>
									<td id="id_td_right_wins_circle_1" align="center"><img
										width="20" src="images/circle_big.png"></td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td align="left"><img id="id_picture_left" width="62"
							height="62" class="circle-mask" src="images/web_title.png"></td>
						<td align="left" width="25%"
							style="color: #b2b1b1; font-size: 27px;" id="id_name_left">사용자
							없음</td>
						<td width="40%"></td>
						<td align="right" width="25%"
							style="color: #b2b1b1; font-size: 27px;" id="id_name_right">사용자
							없음</td>
						<td align="right"><img id="id_picture_right" width="62"
							height="62" class="circle-mask" src="images/web_title.png"></td>
					</tr>
				</table>
			</td>
